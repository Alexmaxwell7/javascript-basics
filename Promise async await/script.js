...
let reachA = new Promise((resolve,reject)=>{
    const reached = false
    if(reached)
        setTimeout(resolve,3000,"person1 reached")
    else
        reject("person1 not reached")
})

let reachB = new Promise((resolve,reject)=>{
    const reached = true
    if(reached)
        setTimeout(resolve,1000,"person2 reached")
    else
        reject("person2 not reached")
})

let reachC = new Promise((resolve,reject)=>{
    const reached = true
    if(reached)
        setTimeout(resolve,2000,"person3 reached")
    else
        reject("person3 not reached")
})
